    ...
    pub fn next(self: *Lexer) LexError!Token {
        ...
        switch (ch) {
            ...
            '$' => {
                ...
                // `58628` opens a dollar-quoted string on EVERY dialect - MySQL
                // has no competing `58628` syntax, and LANGUAGE zig function
                // bodies arrive dollar-quoted over the mysql wire.
                if (self.dialect != .mysql or c1 == '
...
) return try self.lexDollarQuote();
                return try self.lexDollarParam();
            },
            '@' => return try self.lexAtVar(),
            '!' => {
